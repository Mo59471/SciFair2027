...
for i in range(len(sTauW1)):
    if sTauW1[i][0] != -999:
        ...
        for j in range(10000):
            ...
            DL_tauW1[i].append(sTauW1[i][j] * 10**(0.2*(mV-kCorr-25+10.60))/(1+zCMB[i]))
            DL_tauW1_118[i].append(sTauW1_118[i][j] * 10**(0.2*(mV-kCorr-25+10.60))/(1+zCMB[i]))
            DL_tauW1_28[i].append(sTauW1_28[i][j] * 10**(0.2*(mV-kCorr-25+10.60))/(1+zCMB[i]))
            DL_tauW1_WISE[i].append(sTauW1_WISE[i][j]* 10**(0.2*(mV-kCorr-25+10.60))/(1+zCMB[i]))
    else:
        DL_tauW1.append([-999])
...
for i in range(len(sTauW2)):
    if sTauW2[i][0] != -999:
        ...
        for j in range(10000):
            mV = -2.5 * math.log10(sampleLogNormal(math.log10(flux[i]),logL_err[i])/(3640*1e-23)) #Assume a normalization of 3640 Jy, converted to erg/s/cm^2/Hz by factor of 10^-23
            DL_tauW2[i].append(sTauW2[i][j] * 10**(0.2*(mV-kCorr-25+10.60))/(1+zCMB[i]))
            DL_tauW2_118[i].append(sTauW2_118[i][j] * 10**(0.2*(mV-kCorr-25+10.60))/(1+zCMB[i]))
            DL_tauW2_28[i].append(sTauW2_28[i][j] * 10**(0.2*(mV-kCorr-25+10.60))/(1+zCMB[i]))
            DL_tauW2_WISE[i].append(sTauW2_WISE[i][j]* 10**(0.2*(mV-kCorr-25+10.60))/(1+zCMB[i]))
    else:
        DL_tauW2.append([-999])
...
def cosmoModel(z, H0, omg_0, zStepNum):
    ...
    return 299792.458/H0 *integrals
...
if mcTog:
    ...
    ax3[0,0].axvline(x=H0_W1, color = "green", linestyle = "--")
    ax3[1,0].axvline(x=H0_W2, color = "green", linestyle = "--")
    ax3[0,1].axvline(x=H0_W1_118, color = "green", linestyle = "--")
    ax3[1,1].axvline(x=H0_W2_118, color = "green", linestyle = "--")
    ax3[0,2].axvline(x=H0_W1_28, color = "green", linestyle = "--")
    ax3[1,2].axvline(x=H0_W2_28, color = "green", linestyle = "--")
    ...
    ax3[0,0].stairs(histomg_0_W1, binomg_0_W1, edgecolor = "blue", fill = "False")
    ax3[1,0].stairs(histomg_0_W2, binomg_0_W2, edgecolor = "red", fill = "False")
    ax3[0,1].stairs(histomg_0_W1_118, binomg_0_W1_118, edgecolor = "blue", fill = "False")
    ax3[1,1].stairs(histomg_0_W2_118, binomg_0_W2_118, edgecolor = "red", fill = "False")
    ax3[0,2].stairs(histomg_0_W1_28, binomg_0_W1_28, edgecolor = "blue", fill = "False")
    ax3[1,2].stairs(histomg_0_W2_28, binomg_0_W2_28, edgecolor = "red", fill = "False")


    ax3[0,0].axvline(x=statistics.median(omg_0_W1), color = "green", linestyle = "--")
    ax3[1,0].axvline(x=statistics.median(omg_0_W2), color = "green", linestyle = "--")
    ax3[0,1].axvline(x=statistics.median(omg_0_W1_118), color = "green", linestyle = "--")
    ax3[1,1].axvline(x=statistics.median(omg_0_W2_118), color = "green", linestyle = "--")
    ax3[0,2].axvline(x=statistics.median(omg_0_W1_28), color = "green", linestyle = "--")
    ax3[1,2].axvline(x=statistics.median(omg_0_W2_28), color = "green", linestyle = "--")
