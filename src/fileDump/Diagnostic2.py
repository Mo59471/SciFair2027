...
for i in range(len(sTauW1)):
    if sTauW1[i][0] != -999:
        ...
        mV = -2.5 * math.log10(flux[i]/(3640*1e-23))
        DL_tauW1_WISE.append(tauW2[i] * 10**(0.2*(mV-kCorr-25+10.60)))
...
for i in range(len(sTauW2)):
    if sTauW2[i][0] != -999:
        ...
        mV = -2.5 * math.log10(flux[i]/(3640*1e-23))
        DL_tauW2_WISE.append(tauW2[i] * 10**(0.2*(mV-kCorr-25+10.60)))
...
ax[0,0].plot(zCMB_W1, DL_tauW1_WISE, "o", color = "black", ms = 1)
ax[1,0].plot(zCMB_W2, DL_tauW2_WISE, "o", color = "black", ms = 1)
...
if mcTog:
    ...
    ax3[0,0].axvline(x=omg_0_W1, color = "green", linestyle = "--")
    ax3[1,0].axvline(x=omg_0_W2, color = "green", linestyle = "--")
    ax3[0,1].axvline(x=omg_0_W1_118, color = "green", linestyle = "--")
    ax3[1,1].axvline(x=omg_0_W2_118, color = "green", linestyle = "--")
    ax3[0,2].axvline(x=omg_0_W1_28, color = "green", linestyle = "--")
    ax3[1,2].axvline(x=omg_0_W2_28, color = "green", linestyle = "--")
